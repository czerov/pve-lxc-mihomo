...
CONTAINER_GROUP_LINE="  - {name: 容器镜像, type: url-test, proxies: [香港高速, 新加坡节点, 日本节点, 台湾节点, 美国节点], url: 'https://pkg-containers.githubusercontent.com/', interval: 300, tolerance: 20, lazy: true, timeout: 8000, max-failed-times: 2, hidden: false}"
AUTO_GROUP_LINE="  - {name: 自动优选, type: url-test, proxies: [DIRECT], include-all: true, include-all-proxies: true, include-all-providers: true, exclude-filter: \"$FILTER_NOISE\", url: 'https://www.gstatic.com/generate_204', interval: 300, tolerance: 50, lazy: true, timeout: 5000, max-failed-times: 2, hidden: false, icon: 'https://raw.githubusercontent.com/Koolson/Qure/refs/heads/master/IconSet/Color/Auto.png'}"
...
FALLBACK_GROUP_LINE="  - {name: 稳定优选, type: fallback, proxies: [香港高速, 美国节点, 台湾节点, 日本节点, 新加坡节点], url: 'https://www.gstatic.com/generate_204', interval: 300, lazy: true, timeout: 5000, max-failed-times: 2, hidden: false, icon: 'https://raw.githubusercontent.com/Koolson/Qure/refs/heads/master/IconSet/Color/Auto.png'}"
