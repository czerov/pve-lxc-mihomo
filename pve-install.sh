...
run_in_container() {
  ...
  local env_args=(MODE="$LXC_INSTALL_MODE" ROUTING_MODE="$ROUTING_MODE" KDOCS_TUN_STACK="$KDOCS_TUN_STACK" VERSION="$VERSION" NEXUSBOX_INSTALL_URL="$NEXUSBOX_INSTALL_URL" NEXUSBOX_DEFAULT_INSTALL_URL="$NEXUSBOX_DEFAULT_INSTALL_URL" NEXUSBOX_PATCHED_ENABLE="$NEXUSBOX_PATCHED_ENABLE" NEXUSBOX_PATCHED_REPO="$REPO" NEXUSBOX_PATCHED_BRANCH="$BRANCH" NEXUSBOX_PATCHED_REF="$NEXUSBOX_PATCHED_REF" NEXUSBOX_PATCHED_BASE="$NEXUSBOX_PATCHED_BASE" NEXUSBOX_PATCHED_URL="$NEXUSBOX_PATCHED_URL" NEXUSBOX_PATCHED_SHA256="$NEXUSBOX_PATCHED_SHA256" CONFIG_URL="$CONFIG_URL" ZASHBOARD_URL="$ZASHBOARD_URL" SOCIAL_WATCHDOG_ENABLE="$SOCIAL_WATCHDOG_ENABLE" PREFER_CN_ACCEL="$PREFER_CN_ACCEL" GH_PROXY="$GH_PROXY" DOWNLOAD_SPEED_LIMIT="$DOWNLOAD_SPEED_LIMIT" DOWNLOAD_SPEED_TIME="$DOWNLOAD_SPEED_TIME")
